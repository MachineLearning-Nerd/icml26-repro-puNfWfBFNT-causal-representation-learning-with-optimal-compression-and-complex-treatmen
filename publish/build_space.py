...
CURRENT = {
    ...
    "c2": {"title": "Thm 3.5 deviation bound", "status": "**BLOCKED** (assumption unsatisfiable)",
           "note": "Assumption 3.4(i) fails in 216/216 audited cells",
    ...
    "c4": {"title": "Thm 3.8 / Cor 3.9 variance scaling",
           "status": "**BLOCKED** (assumption unsatisfiable)",
           "note": "interiority required by Assumption 3.7(i) never holds",
           "page": "pages/claims/c2c4-current.md"},
